...
void readBanLists(void)
{
	...
	q2a_strcpy(cfgRemoteFileEnabled, q2adminbanremotetxt_enable->string);
	...
	if ( cfgRemoteFileEnabled[0] == '1') 
	{
	    ...
	    if(!q2adminbanremotetxt || isBlank(q2adminbanremotetxt->string))
		    {
			q2a_strcpy(cfgRemoteFile, BANLISTREMOTEFILE);
		    }
	    else
		    {
			q2a_strcpy(cfgRemoteFile, q2adminbanremotetxt->string);
		    }
